...
(36, '', 285, '', 1, '', 'C', '', '0', '', '', '2020-01-14', ''),
(37, '', 286, '', 1, '', 'C', '', '0', '', '', '2020-01-14', ''),
(38, '', 287, '', 1, '', 'C', '', '0', '', '', '2020-01-14', '');
...
--
-- Table structure for table `tbl_applicant_agreement`
--

CREATE TABLE `tbl_applicant_agreement` (
  `agreement_id` int(11) NOT NULL,
  `member_id` varchar(100) NOT NULL,
  `doc_requirements` varchar(100) NOT NULL,
  `subs_atleast` varchar(50) NOT NULL,
  `value_atleast` varchar(50) NOT NULL,
  `signature_file` varchar(50) NOT NULL,
  `date_added` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbl_applicant_agreement`
--

INSERT INTO `tbl_applicant_agreement` (`agreement_id`, `member_id`, `doc_requirements`, `subs_atleast`, `value_atleast`, `signature_file`, `date_added`) VALUES
(11, '1234566', '{\"filled_form\":true,\"2x_id\":true,\"tin\":true}', '100', '100', '200114-5e1d34787ef84.png', '2020-01-14'),
(12, '1234566', '{\"filled_form\":true,\"2x_id\":true,\"tin\":true}', '100', '100', '200114-5e1d80cd5d5e1.png', '2020-01-14');
...
(145, 283, '{\"salary_honorarium\":\"on\",\"interest_commission\":\"on\",\"source_business\":null,\"ofw_remitance\":\"on\",\"source_farmer\":null,\"other_remittance\":null,\"pension\":null,\"others\":null}', '{\"corn\":null,\"sugarcane\":null,\"rice\":null,\"fruits\":null,\"cash\":null,\"livestock\":null}', '', '', '', '', '', '', '20001 - 30000', '232323'),
(146, 284, '{\"salary_honorarium\":\"on\",\"interest_commission\":\"on\",\"source_business\":null,\"ofw_remitance\":\"on\",\"source_farmer\":null,\"other_remittance\":null,\"pension\":null,\"others\":null}', '{\"corn\":null,\"sugarcane\":null,\"rice\":null,\"fruits\":null,\"cash\":null,\"livestock\":null}', '', '', '', '', '', '', '20001 - 30000', '232323'),
(147, 285, '{\"salary_honorarium\":\"on\",\"interest_commission\":\"on\",\"source_business\":null,\"ofw_remitance\":\"on\",\"source_farmer\":null,\"other_remittance\":null,\"pension\":null,\"others\":null}', '{\"corn\":null,\"sugarcane\":null,\"rice\":null,\"fruits\":null,\"cash\":null,\"livestock\":null}', '', '', '', '', '', '', '20001 - 30000', '232323'),
(148, 286, '{\"salary_honorarium\":\"on\",\"interest_commission\":\"on\",\"source_business\":\"on\",\"ofw_remitance\":\"on\",\"source_farmer\":\"on\",\"other_remittance\":\"on\",\"pension\":\"on\",\"others\":\"Anna\"}', '{\"corn\":\"rented\",\"sugarcane\":\"rented\",\"rice\":\"rented\",\"fruits\":\"rented\",\"cash\":\"rented\",\"livestock\":\"rented\"}', 'Sue', '7669 Gulf Drive', 'Frank', 'Kerry', 'Uy', 'Cliff', 'Above 50000', 'Frank'),
(149, 287, '{\"salary_honorarium\":\"on\",\"interest_commission\":\"on\",\"source_business\":\"on\",\"ofw_remitance\":\"on\",\"source_farmer\":\"on\",\"other_remittance\":\"on\",\"pension\":\"on\",\"others\":\"Cliff\"}', '{\"corn\":\"rented\",\"sugarcane\":\"rented\",\"rice\":\"rented\",\"fruits\":\"rented\",\"cash\":\"rented\",\"livestock\":\"rented\"}', 'Cruiser', '7669 Gulf Drive', 'Terry', 'Kerry', 'Peter', 'Kerry', 'Above 50000', 'Cliff');
...
(112, 283, 'College Level', 'Proweaver Test Kerry', '01/14/2020'),
(113, 284, 'College Level', 'Proweaver Test Kerry', '01/14/2020'),
(114, 285, 'College Level', 'Proweaver Test Kerry', '01/14/2020'),
(115, 286, 'Secondary', 'Cruiser', 'Holly'),
(116, 287, 'College Grad', 'Kerry', 'Frank');
...
(110, 283, 'Private Employee', 'Proweaver Test', 'Proweaver Test', 'Terry, 162 Little Embers Court', 'Janitor', 'Manager'),
(111, 284, 'Private Employee', 'Proweaver Test', 'Proweaver Test', 'Terry, 162 Little Embers Court', 'Janitor', 'Manager'),
(112, 285, 'Private Employee', 'Proweaver Test', 'Proweaver Test', 'Terry, 162 Little Embers Court', 'Janitor', 'Manager'),
(113, 286, 'Government Employee', 'Tom', 'Terry', '162 Little Embers Court', 'Kerry', 'Sue'),
(114, 287, 'Student', 'Petey', 'Brock', '7669 Gulf Drive', 'Bob', 'Frank');
...
(283, '20D7ED01CCE7', 1, 'Kerry', 'Proweaver', 'Test', '24', '', 'T', '01/13/2020', 'TEST', 'example@proweaver.com', 'United States', 'Married', 'Male', '2025550140', '', '', '', '12/03/2019'),
(284, '20D7ED868D01', 1, 'Kerry', 'Proweaver', 'Test', '24', '', 'T', '01/13/2020', 'TEST', 'example@proweaver.com', 'United States', 'Married', 'Male', '2025550140', '', '', '', '12/03/2019'),
(285, '20D7F61C7009', 1, 'Kerry', 'Proweaver', 'Test', '24', '', 'T', '01/13/2020', 'TEST', 'example@proweaver.com', 'United States', 'Married', 'Male', '2025550140', '', '', '', '12/03/2019'),
(286, '20D805B97D04', 1, 'Cliff', 'Holly', 'Cory', '0', 'Cliff', 'Uy', 'Anna', 'Uy', 'example@proweaver.com', 'Matt', 'Married', 'Female', 'Sue', 'Mull', 'Marion', 'Uy', '01/27/2020'),
(287, '20D80BC86CA0', 1, 'Mull', 'Bob', 'Sue', '0', 'Uy', 'Kerry', 'Matt', 'Peter', 'proweaver@example.com', 'Cruiser', 'Married', 'Female', 'Cory', 'Kerry', 'Uy', 'Marion', '01/14/2020');
...
(110, 283, 'Renting', '3178 Quiet Trail, 162 Little Embers Court, 162 Little Embers Court, 162 Little Embers Court', 'Kamagayan', 'Spring Valley', 'Michigan', 22345),
(111, 284, 'Renting', '3178 Quiet Trail, 162 Little Embers Court, 162 Little Embers Court, 162 Little Embers Court', 'Kamagayan', 'Spring Valley', 'Michigan', 22345),
(112, 285, 'Renting', '3178 Quiet Trail, 162 Little Embers Court, 162 Little Embers Court, 162 Little Embers Court', 'Kamagayan', 'Spring Valley', 'Michigan', 22345),
(113, 286, 'Owned', 'Petey', 'Leonardo', 'Peter', 'Tom', 0),
(114, 287, 'Owned', 'Lynn', 'Cliff', 'Leonardo', 'Terry', 0);
...
(98, 281, 'Student', '', '', '', '', ''),
(99, 282, 'Student', '', '', '', '', ''),
(100, 283, 'Private Employee', 'Proweaver Test', 'Proweaver Test', 'Terry', 'test', 'test'),
(101, 284, 'Private Employee', 'Proweaver Test', 'Proweaver Test', 'Terry', 'test', 'test'),
(102, 285, 'Private Employee', 'Proweaver Test', 'Proweaver Test', 'Terry', 'test', 'test'),
(103, 286, 'Farmer', 'Leonardo', 'Terry', '7339 Silver Pine Highlands', 'Lynn', 'Cory'),
(104, 287, 'Government Employee', 'Leonardo', 'Cory', '9170 N. Summerhouse St.', 'Cruiser', 'Sue');
...
(109, 282, '', '', '', '', '', '', ''),
(110, 283, 'Kerry', 'Proweaver', 'Test', '11/15/2019', '2025550140', 'United States', '12345678'),
(111, 284, 'Kerry', 'Proweaver', 'Test', '11/15/2019', '2025550140', 'United States', '12345678'),
(112, 285, 'Kerry', 'Proweaver', 'Test', '11/15/2019', '2025550140', 'United States', '12345678'),
(113, 286, 'Anna', 'Cruiser', 'Frank', 'Mull', 'Uy', 'Lynn', 'Kerry'),
(114, 287, 'Cory', 'Leonardo', 'Terry', 'Anna', 'Leonardo', 'Tom', 'Tom');
...
(50, '285', '200114-5e1d7f61d33ed.jpg', '2020-01-14'),
(51, '286', '200114-5e1d805ba9d8a.jpg', '2020-01-14'),
(52, '287', '200114-5e1d80bc9b360.jpg', '2020-01-14');
...
(180, 283, '200114-5e1d7ed01d2d7.png', ''),
(181, 284, '200114-5e1d7ed8692d6.png', ''),
(182, 285, '200114-5e1d7f61c7615.png', ''),
(183, 286, '200114-5e1d805b9836f.png', ''),
(184, 287, '200114-5e1d80bc87298.png', '');
...
(11, 0, 1, 'durk1995', 'durk1995', 0, 1, '2020-01-10', '0000-00-00'),
(12, 0, 0, 'durk1995@proweaver.net', 'durk1995', 0, 1, '2020-01-14', '0000-00-00');
...
(11, 'Matthew Derek', '', 'Amaba', '', '2020-01-10', '0000-00-00'),
(12, 'Matthew Derek', '', 'Amaba', '', '2020-01-14', '0000-00-00'),
...
--
-- Indexes for table `tbl_applicant_agreement`
--
ALTER TABLE `tbl_applicant_agreement`
...
--
ALTER TABLE `tbl_account_info`
  MODIFY `account_info_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
--
-- AUTO_INCREMENT for table `tbl_applicant_agreement`
--
ALTER TABLE `tbl_applicant_agreement`
  MODIFY `agreement_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tbl_financial_info`
  MODIFY `financial_info_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=150;
...
--
ALTER TABLE `tbl_mem_education_attainment`
  MODIFY `education_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=117;

--
-- AUTO_INCREMENT for table `tbl_mem_eployment_information`
--
ALTER TABLE `tbl_mem_eployment_information`
  MODIFY `employmentInfo_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;

--
-- AUTO_INCREMENT for table `tbl_mem_personal_information`
--
ALTER TABLE `tbl_mem_personal_information`
  MODIFY `member_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=288;

--
-- AUTO_INCREMENT for table `tbl_mem_residence`
--
ALTER TABLE `tbl_mem_residence`
  MODIFY `residence_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;

--
-- AUTO_INCREMENT for table `tbl_mem_spouse_emp_info`
--
ALTER TABLE `tbl_mem_spouse_emp_info`
  MODIFY `spouse_emp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=105;

--
-- AUTO_INCREMENT for table `tbl_mem_spouse_information`
--
ALTER TABLE `tbl_mem_spouse_information`
  MODIFY `spouse_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;

--
-- AUTO_INCREMENT for table `tbl_monetary_req`
--
ALTER TABLE `tbl_monetary_req`
  MODIFY `monetary_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `tbl_signatures`
  MODIFY `signature_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=185;
...
--
ALTER TABLE `tbl_user_credentials`
  MODIFY `credentials_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
