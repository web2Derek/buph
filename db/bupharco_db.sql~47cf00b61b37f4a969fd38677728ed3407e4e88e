...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 17, 2019 at 10:57 AM
...
(239, 'AG1985FFBEFDA9', 1, 'Mull', 'Uy', 'Cliff', 'Lynn', 'Lynn', 'Anna', 'Marion', 'Peter', 'proweaver@example.com', 'Anna', 'Single', 'Female', 'Mull', 'Mull', 'Uy', 'Lynn', 'Tom'),
(240, 'AG1985FFD6C217', 1, 'Mull', 'Uy', 'Cliff', 'Lynn', 'Lynn', 'Anna', 'Marion', 'Peter', 'proweaver@example.com', 'Anna', 'Single', 'Female', 'Mull', 'Mull', 'Uy', 'Lynn', 'Tom'),
(241, 'AG198602525D5C', 1, 'Mull', 'Uy', 'Cliff', 'Lynn', 'Lynn', 'Anna', 'Marion', 'Peter', 'proweaver@example.com', 'Anna', 'Single', 'Female', 'Mull', 'Mull', 'Uy', 'Lynn', 'Tom'),
(242, 'AG198603B6BB97', 1, 'Anna', 'Peter', 'Brock', 'Petey', 'Cliff', 'Petey', 'Matt', 'Bob', 'proweaver@example.com', 'Frank', 'Single', 'Male', 'Mull', 'Peter', 'Kerry', 'Anna', 'Holly'),
(243, 'AG19860CE5BBEA', 1, 'Cruiser', 'Matt', 'Frank', 'Cruiser', 'Bob', 'Uy', 'Cliff', 'Mull', 'proweaver@example.com', 'Frank', 'Single', 'Male', 'Holly', 'Cliff', 'Terry', 'Tom', 'Matt');
...
(1, 1, 3, 'admin', 'admin', 2, 1, '2019-09-26', '2019-09-26'),
(6, 15, 1, 'user1', 'user1', 1, 1, '2019-10-10', '2019-10-10'),
(7, 16, 2, 'user', 'user', 0, 0, '2019-12-04', '2019-12-04'),
...
--
ALTER TABLE `tbl_financial_info`
MODIFY `financial_info_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=126;
--
...
--
ALTER TABLE `tbl_mem_education_attainment`
MODIFY `education_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=92;
--
-- AUTO_INCREMENT for table `tbl_mem_eployment_information`
--
ALTER TABLE `tbl_mem_eployment_information`
MODIFY `employmentInfo_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=90;
--
-- AUTO_INCREMENT for table `tbl_mem_personal_information`
--
ALTER TABLE `tbl_mem_personal_information`
MODIFY `member_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=244;
--
-- AUTO_INCREMENT for table `tbl_mem_residence`
--
ALTER TABLE `tbl_mem_residence`
MODIFY `residence_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=90;
--
-- AUTO_INCREMENT for table `tbl_mem_spouse_emp_info`
--
ALTER TABLE `tbl_mem_spouse_emp_info`
MODIFY `spouse_emp_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=80;
--
-- AUTO_INCREMENT for table `tbl_mem_spouse_information`
--
ALTER TABLE `tbl_mem_spouse_information`
MODIFY `spouse_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=90;
--
...
--
ALTER TABLE `tbl_signatures`
MODIFY `signature_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=136;
--
