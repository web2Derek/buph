          ...
          <div class="card">
              <div class="card-body">
                <div class="d-flex m-b-30 no-block">
                    <h5 class="card-title m-b-0 align-self-center">New Member (September 2019)</h5>
                        <div class="ml-auto col-md-4">
                            <select class="custom-select" name="" id="group-ype">
                            ...
                            <h4 class="card-title">Total Member Summary</h4>
                             <div class="ml-auto col-md-4">
                                    <select class="custom-select" name="">
                                          <option value="Regular Mal">Regular Male</option>
