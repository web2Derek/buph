...
class Members extends MY_Controller {
  ...
  public function getMembers(){
    ...
    $column_order = array('tbl_member_types.type_id','first_name','middle_name','acount_id','birthdate','age','blood_type' , 'gender' , 'civil_status' , 'branch_name');
    $select = "tbl_member_types.type_id, first_name,middle_name,last_name,acount_id , birthdate,age,blood_type , religion , branch_name ,civil_status , title , gender, tbl_mem_personal_information.member_id";
    $join = array(
      'tbl_member_types'  => 'tbl_mem_personal_information.member_type_id = tbl_member_types.type_id',
      'tbl_mem_residence' => 'tbl_mem_personal_information.member_id = tbl_mem_residence.member_id',
